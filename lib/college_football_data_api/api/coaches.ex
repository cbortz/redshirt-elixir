...
defmodule CollegeFootballDataAPI.Api.Coaches do
  @moduledoc """
  ...
  """
  @spec get_coaches(Tesla.Env.client, keyword()) :: {:ok, list(CollegeFootballDataAPI.Model.Coach.t)} | {:error, Tesla.Env.t}
  def get_coaches(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.Coach{}]}
    ])
  end
end
