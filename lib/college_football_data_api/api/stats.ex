...
defmodule CollegeFootballDataAPI.Api.Stats do
  @moduledoc """
  ...
  """
  @spec get_advanced_team_game_stats(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.AdvancedGameStat.t)} | {:error, Tesla.Env.t}
  def get_advanced_team_game_stats(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.AdvancedGameStat{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_advanced_team_season_stats(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.AdvancedSeasonStat.t)} | {:error, Tesla.Env.t}
  def get_advanced_team_season_stats(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.AdvancedSeasonStat{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_team_season_stats(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.TeamSeasonStat.t)} | {:error, Tesla.Env.t}
  def get_team_season_stats(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.TeamSeasonStat{}]},
      {400, false}
    ])
  end
end
