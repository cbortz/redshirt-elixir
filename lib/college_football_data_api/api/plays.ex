...
defmodule CollegeFootballDataAPI.Api.Plays do
  @moduledoc """
  ...
  - `{:ok, CollegeFootballDataAPI.Model.LivePlayByPlay.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_live_plays(Tesla.Env.client, integer(), keyword()) :: {:ok, CollegeFootballDataAPI.Model.LivePlayByPlay.t} | {:error, Tesla.Env.t}
  def get_live_plays(connection, id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %CollegeFootballDataAPI.Model.LivePlayByPlay{}}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_play_stat_types(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PlayStatType.t)} | {:error, Tesla.Env.t}
  def get_play_stat_types(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayStatType{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_play_stats(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PlayStat.t)} | {:error, Tesla.Env.t}
  def get_play_stats(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayStat{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_play_types(Tesla.Env.client, keyword()) :: {:ok, list(CollegeFootballDataAPI.Model.PlayType.t)} | {:error, Tesla.Env.t}
  def get_play_types(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayType{}]}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_plays(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(CollegeFootballDataAPI.Model.Play.t)} | {:error, Tesla.Env.t}
  def get_plays(connection, year, week, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.Play{}]}
    ])
  end
end
