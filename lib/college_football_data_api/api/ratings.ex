...
defmodule CollegeFootballDataAPI.Api.Ratings do
  @moduledoc """
  ...
  """
  @spec get_conference_sp_ratings(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.ConferenceSpRating.t)} | {:error, Tesla.Env.t}
  def get_conference_sp_ratings(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.ConferenceSpRating{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_elo_ratings(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.TeamEloRating.t)} | {:error, Tesla.Env.t}
  def get_elo_ratings(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.TeamEloRating{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_sp_ratings(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.TeamSpRating.t)} | {:error, Tesla.Env.t}
  def get_sp_ratings(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.TeamSpRating{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_srs_ratings(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.TeamSrsRating.t)} | {:error, Tesla.Env.t}
  def get_srs_ratings(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.TeamSrsRating{}]},
      {400, false}
    ])
  end
end
