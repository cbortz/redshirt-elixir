...
defmodule CollegeFootballDataAPI.Api.Drives do
  @moduledoc """
  ...
  """
  @spec get_drives(Tesla.Env.client, integer(), keyword()) :: {:ok, list(CollegeFootballDataAPI.Model.Drive.t)} | {:error, Tesla.Env.t}
  def get_drives(connection, year, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.Drive{}]}
    ])
  end
end
