...
defmodule CollegeFootballDataAPI.Api.Players do
  @moduledoc """
  ...
  """
  @spec get_player_season_stats(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PlayerSeasonStat.t)} | {:error, Tesla.Env.t}
  def get_player_season_stats(connection, year, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayerSeasonStat{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_player_usage(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PlayerUsage.t)} | {:error, Tesla.Env.t}
  def get_player_usage(connection, year, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayerUsage{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_returning_production(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.ReturningProduction.t)} | {:error, Tesla.Env.t}
  def get_returning_production(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.ReturningProduction{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_transfer_portal(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PortalPlayer.t)} | {:error, Tesla.Env.t}
  def get_transfer_portal(connection, year, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PortalPlayer{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec player_search(Tesla.Env.client, String.t, keyword()) :: {:ok, list(CollegeFootballDataAPI.Model.PlayerSearchResult.t)} | {:ok, nil} | {:error, Tesla.Env.t}
  def player_search(connection, search_term, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayerSearchResult{}]},
      {400, false}
    ])
  end
end
