...
defmodule CollegeFootballDataAPI.Api.Metrics do
  @moduledoc """
  ...
  """
  @spec get_game_ppa(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.GamePpa.t)} | {:error, Tesla.Env.t}
  def get_game_ppa(connection, year, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.GamePpa{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_player_game_ppa(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PlayerGamePpa.t)} | {:error, Tesla.Env.t}
  def get_player_game_ppa(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayerGamePpa{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_player_season_ppa(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PlayerSeasonPpa.t)} | {:error, Tesla.Env.t}
  def get_player_season_ppa(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayerSeasonPpa{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_predicted_points(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PredictedPoints.t)} | {:error, Tesla.Env.t}
  def get_predicted_points(connection, down, distance, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PredictedPoints{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_pregame_win_probabilities(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PregameWp.t)} | {:error, Tesla.Env.t}
  def get_pregame_win_probabilities(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PregameWp{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_team_ppa(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.TeamPpa.t)} | {:error, Tesla.Env.t}
  def get_team_ppa(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.TeamPpa{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_win_probability_data(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PlayWp.t)} | {:error, Tesla.Env.t}
  def get_win_probability_data(connection, game_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PlayWp{}]},
      {400, false}
    ])
  end
end
