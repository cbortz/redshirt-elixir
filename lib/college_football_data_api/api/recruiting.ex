...
defmodule CollegeFootballDataAPI.Api.Recruiting do
  @moduledoc """
  ...
  """
  @spec get_recruiting_groups(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.PositionGroupRecruitingRating.t)} | {:error, Tesla.Env.t}
  def get_recruiting_groups(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.PositionGroupRecruitingRating{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_recruiting_players(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.Recruit.t)} | {:error, Tesla.Env.t}
  def get_recruiting_players(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.Recruit{}]},
      {400, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_recruiting_teams(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(CollegeFootballDataAPI.Model.TeamRecruitingRank.t)} | {:error, Tesla.Env.t}
  def get_recruiting_teams(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%CollegeFootballDataAPI.Model.TeamRecruitingRank{}]},
      {400, false}
    ])
  end
end
