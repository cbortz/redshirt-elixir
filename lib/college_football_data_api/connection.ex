...
defmodule CollegeFootballDataAPI.Connection do
  @moduledoc """
  Handle Tesla connections for CollegeFootballDataAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, CollegeFootballDataAPI.Connection,
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - CollegeFootballDataAPI 4.4.12 - elixir"
        )
      )
