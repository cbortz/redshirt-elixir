...
defmodule CollegeFootballDataAPI.Model.Drive do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :start_time => CollegeFootballDataAPI.Model.DriveStartTime.t | nil,
    :end_period => integer() | nil,
    :end_yardline => integer() | nil,
    :end_yards_to_goal => integer() | nil,
    :end_time => CollegeFootballDataAPI.Model.DriveStartTime.t | nil,
    :plays => integer() | nil,
    :yards => integer() | nil,
...
defimpl Poison.Decoder, for: CollegeFootballDataAPI.Model.Drive do
  import CollegeFootballDataAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:start_time, :struct, CollegeFootballDataAPI.Model.DriveStartTime, options)
    |> deserialize(:end_time, :struct, CollegeFootballDataAPI.Model.DriveStartTime, options)
  end
end
